...
/*
 * NOTE: This file was historically wrapped in
 * `#if !defined(DISABLE_NETWORKING)` but AIStream/AIStreamBE/AIStreamLE and
 * AStream::failure are general-purpose file I/O used by the image loader
 * and sound system, so they must be compiled even when networking is disabled
 * (e.g. the Vita port).
 */
