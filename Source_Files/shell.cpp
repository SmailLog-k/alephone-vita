...
#ifdef VITA
	SDL_setenv("SDL_AUDIODRIVER", "vita", 0);
	SDL_setenv("SDL_VIDEODRIVER", "vita", 0);
	vita_platform_log("Aleph One Vita: calling SDL_Init");
#endif
...
#ifdef VITA
		vita_platform_log(sdl_err ? sdl_err : "Aleph One Vita: SDL_Init failed");
#endif
		if (sdl_err)
...
#ifdef VITA
	vita_alephone_apply_performance_preferences();
#endif
...
#ifdef VITA
			vita_alephone_handle_vita_events();
#endif
