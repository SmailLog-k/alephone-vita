...
struct world_vector3d
{
	...
	friend constexpr bool operator==(const world_vector3d& a, const world_vector3d& b) {
...
struct world_point3d
{
	...
	friend constexpr bool operator==(const world_point3d& a, const world_point3d& b) {
